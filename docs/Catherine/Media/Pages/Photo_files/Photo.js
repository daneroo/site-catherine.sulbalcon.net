...
{return IWCreatePhotocast("http://catherine.sulbalcon.net/Catherine/Media/Pages/Photo_files/rss.xml",true);}
function initializeMediaStream_id4()
{createMediaStream_id4().load('http://catherine.sulbalcon.net/Catherine/Media/Pages',function(imageStream)
...
IWLayoutPhotoGrid('id4',new IWPhotoGridLayout(3,new IWSize(218,218),new IWSize(218,37),new IWSize(218,270),27,27,0,new IWSize(18,18)),new IWPhotoFrame([IWCreateImage('Photo_files/Hardcover_bevel_01.png'),IWCreateImage('Photo_files/Hardcover_bevel_02.png'),IWCreateImage('Photo_files/Hardcover_bevel_03.png'),IWCreateImage('Photo_files/Hardcover_bevel_06.png'),IWCreateImage('Photo_files/Hardcover_bevel_09.png'),IWCreateImage('Photo_files/Hardcover_bevel_08.png'),IWCreateImage('Photo_files/Hardcover_bevel_07.png'),IWCreateImage('Photo_files/Hardcover_bevel_04.png')],null,0,0.500000,0.000000,0.000000,0.000000,0.000000,17.000000,17.000000,17.000000,17.000000,403.000000,295.000000,403.000000,295.000000,null,null,null,0.100000),imageStream,range,null,null,1.000000,{backgroundColor:'rgb(0, 0, 0)',reflectionHeight:100,reflectionOffset:2,captionHeight:100,fullScreen:0,transitionIndex:2},'../../Media/slideshow.html','widget1','widget2','widget3')});}
